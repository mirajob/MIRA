...
/**
 * Vecchio percorso a chat, ancora attivo per le associazioni fuori dalla beta. Va rimosso
 * quando la nuova card del ciclo viene accesa per tutti.
 */
export function ChatCycleWizard() {
